...
const consultationSchema = z.object({
  ...
  folicAcid: z.string().optional(),
  ferritin: z.string().optional(),
  transferrin: z.string().optional(),
  vitB12: z.string().optional(),
  homocysteine: z.string().optional(),
  vitD3: z.string().optional(),
  electrolytesNa: z.string().optional(),
  electrolytesK: z.string().optional(),
  electrolytesMg: z.string().optional(),
  ...
  tgThyroidMarker: z.string().optional(),
  antyTPO: z.string().optional(),
  antyTG: z.string().optional(),
  trab: z.string().optional(),
  ...
  androstendion: z.string().optional(),
  sDHEA: z.string().optional(),
  totalTestosterone: z.string().optional(),
  dht: z.string().optional(),
  shgb: z.string().optional(),
  cortisol: z.string().optional(),
  ana1: z.string().optional(),
  ana2: z.string().optional(),
  helicobacter: z.string().optional(),
  glucose: z.string().optional(),
  hba1c: z.string().optional(),
  insulin: z.string().optional(),
  candidaAlbicans: z.string().optional(),
  histamine: z.string().optional(),
  parasites: z.string().optional(),
  woodLamp: z.string().optional(),
  demodex: z.string().optional(),
  mycologicalTest: z.string().optional(),
  microbiologicalTest: z.string().optional(),
});
