...
exports.getLogoHTML = getLogoHTML;
exports.getLogoHTMLForPDF = getLogoHTMLForPDF;
...
function getLogoBase64() {
    try {
        ...
        const possiblePaths = [
            path_1.default.join(__dirname, '../../public/assets/logo.png'), // From dist/utils/logo.js
            path_1.default.join(__dirname, '../../../public/assets/logo.png'), // Alternative path
            path_1.default.join(process.cwd(), 'public/assets/logo.png'), // From project root
            path_1.default.join(process.cwd(), 'backend/public/assets/logo.png'), // From workspace root
        ];
 ...
 */
function getLogoHTML(baseUrl, size = 'medium') {
 ...
 */
function getLogoHTMLForPDF(size = 'medium') {
    const logoBase64 = getLogoBase64();
    const sizes = {
        small: 'height: 30px;',
        medium: 'height: 50px;',
