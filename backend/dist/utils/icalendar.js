...
exports.generateVisitICS = generateVisitICS;
 ...
 */
function generateVisitICS(visit) {
    ...
    const description = escapeICS(`Wizyta: ${visit.rodzajZabiegu}\n` +
 ...
 */
function generateOutlookCalendarURL(visit) {
    const startDate = new Date(visit.data);
