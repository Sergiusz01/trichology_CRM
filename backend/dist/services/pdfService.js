...
exports.generatePatientInfoPDF = exports.generateLabResultPDF = exports.generateCarePlanPDF = exports.generateConsultationPDF = exports.formatDateTime = exports.formatDate = void 0;
...
const renderCheckboxInfo = (label, value, isBoolean = false) => {
...
const chk = (val, opt) => {
    ...
    if (Array.isArray(val))
        s = val.map(String).join(',').toLowerCase();
...
const generateConsultationPDF = async (consultation) => {
    ...
    ${(0, logo_1.getLogoHTMLForPDF)('small')}
    ...
    <div class="page">
      ...
      <div>Data konsultacji: <strong>${(0, exports.formatDate)(c.consultationDate)}</strong></div>
    ...
    <div class="page">
      ...
      <div>Data: ${lab ? (0, exports.formatDate)(lab.date) : ''}</div>
    ...
    <div class="page">
      ...
      <div style="margin-top:40px; font-size:7pt; color:#666; text-align:right;">
        Dokument wygenerowany elektronicznie. Lekarz: ${escapeHtml(c.doctor?.name || '')} | ${(0, exports.formatDateTime)(new Date())}
      </div>
    </div>
...
exports.generateConsultationPDF = generateConsultationPDF;
const generateCarePlanPDF = async (carePlan) => {
    const html = `
    <!DOCTYPE html>
    <html lang="pl">
    <head>
    ...
    <body>
      ...
      <div style="margin-top: 40px; text-align: right; font-size: 9pt; color: #666;">
        <p>Wygenerowano: ${(0, exports.formatDateTime)(new Date())}</p>
...
exports.generateCarePlanPDF = generateCarePlanPDF;
var pdfServiceAdditional_1 = require("./pdfServiceAdditional");
Object.defineProperty(exports, "generateLabResultPDF", { enumerable: true, get: function () { return pdfServiceAdditional_1.generateLabResultPDF; } });
Object.defineProperty(exports, "generatePatientInfoPDF", { enumerable: true, get: function () { return pdfServiceAdditional_1.generatePatientInfoPDF; } });
