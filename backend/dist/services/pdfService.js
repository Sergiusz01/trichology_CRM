    ...
    <body>
      ...
      <div class="header-main">
        ...
        <div style="font-size: 9pt; margin-top: 5px; text-align: right;">
          Data konsultacji: <strong>${(0, exports.formatDate)(consultation.consultationDate)}</strong>
        </div>
      </div>
      ...
      <div class="footer">
        Dokument wygenerowany elektronicznie. Lekarz prowadzący: ${escapeHtml(consultation.doctor?.name || 'Nieznany')} | Data wydruku: ${(0, exports.formatDateTime)(new Date())}
      </div>
