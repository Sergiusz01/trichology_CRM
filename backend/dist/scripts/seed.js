...
const seedDefaultConsultationTemplate_1 = require("./seedDefaultConsultationTemplate");
...
async function main() {
    ...
    // Create doctor user
    const doctorPassword = await (0, password_1.hashPassword)('doctor123');
    ...
    if (!existingTemplate) {
        await prisma.consultationTemplate.create({
            data: {
                ...
                doctorId: doctor.id,
                fields: (0, seedDefaultConsultationTemplate_1.generateDefaultFields)(),
                isDefault: true,
                isActive: true,
            },
        });
    ...
    await (0, initializeDefaultTemplates_1.initializeDefaultTemplates)(admin.id, prisma);
