...
export const VISIT_STATUS_CONFIG: Record<string, { label: string; color: string; bgColor: string }> = {
  ...
  POTWIERDZONA:  { label: 'Potwierdzona',             color: '#34C759', bgColor: 'rgba(52, 199, 89, 0.1)' },
  ODBYTA:        { label: 'Odbyta',                   color: '#007AFF', bgColor: 'rgba(0, 122, 255, 0.1)' },
  ...
  PROSBA_ZMIANY: { label: 'Prośba o zmianę terminu', color: '#AF52DE', bgColor: 'rgba(175, 82, 222, 0.1)' },
};
