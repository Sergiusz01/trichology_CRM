  ...
  return (
    <Box>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 3 }}>
        <Typography variant="h4">Pacjenci</Typography>
        <Button
          variant="contained"
          startIcon={<Add />}
      ...
      <Paper sx={{ mb: 2 }}>
        <TextField
          fullWidth
          label="Szukaj (imię, nazwisko, telefon, email)"
          value={search}
          onChange={(e) => {
        ...
        <DialogContent>
          <DialogContentText>
            ...
            <Typography variant="body2" color="warning.main" sx={{ mt: 1 }}>
              Uwaga: Pacjent zostanie zarchiwizowany (soft delete). Wszystkie powiązane dane (konsultacje, wyniki badań, zdjęcia, plany opieki) pozostaną w systemie.
            </Typography>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
