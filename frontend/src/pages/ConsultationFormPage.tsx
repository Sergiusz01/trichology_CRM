...
export default function ConsultationFormPage() {
  ...
  return (
    <Box sx={{ width: '100%', maxWidth: '100%', overflow: 'hidden', px: { xs: 0, sm: 0 } }}>
      <PageHeader
        title={isNewConsultation ? 'Nowa konsultacja' : 'Edycja konsultacji'}
        backPath={actualPatientId ? `/patients/${actualPatientId}` : '/patients'}
        backLabel="Powrót do profilu"
        action={
      ...
      <form onSubmit={handleSubmit}>
        ...
        {!useTemplate && (
          <>
            ...
            {/* Hair Loss Section */}
            <Section title="1. Wypadanie włosów" defaultExpanded>
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, md: 6 }}>
            ...
            {/* Oily Hair Section */}
            <Section title="2. Przetłuszczanie się włosów">
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <FormControl fullWidth>
                    <InputLabel>Nasilenie</InputLabel>
            ...
            {/* Scaling Section */}
            <Section title="3. Łuszczenie skóry głowy">
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <FormControl fullWidth>
                    <InputLabel>Nasilenie</InputLabel>
            ...
            <Section title="4. Wrażliwość skóry głowy">
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <FormControl fullWidth>
                    <InputLabel>Nasilenie</InputLabel>
            ...
            {/* Inflammatory States */}
            <Section title="5. Stany zapalne (krostki, strupki)">
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <FormControl fullWidth>
                    <InputLabel>Nasilenie</InputLabel>
            ...
            <Section title="9. Diagnostyka łysienia">
              <Grid container spacing={2}>
                <Grid size={{ xs: 12 }}>
                  <MultiSelectCheckboxes
                    label="Łysienie"
            ...
            {/* Visits/Procedures */}
            <Section title="12. Wizyty / Zabiegi">
              <TextField
                fullWidth
                multiline
                rows={4}
            ...
            {/* Scales Section */}
            <Section title="13. Skale Norwood-Hamilton i Ludwig">
              <Grid container spacing={2}>
                <Grid size={{ xs: 12, md: 6 }}>
                  <TextField
                    fullWidth
